...
// The car dealer has all of their inventory housed in the array seen below.  Scroll down past the data 
//to find out how you can help the car dealer.
...
// for (i = 0; i < arr.length; i++) {
//     console.log(`${inventory[i].id} is a ${car_year} + ${car_make} + ${car_model}`);
// }
